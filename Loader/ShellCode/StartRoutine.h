...
using f_NtCreateThreadEx = NTSTATUS(__stdcall*)(HANDLE* pThreadHandleOut, ACCESS_MASK DesiredAccess, void* pAttr, HANDLE hProc, 
												void* pRoutine, void* pArg, ULONG Flags, SIZE_T ZeroBits, 
...
#define SR_ERR_OPEN_FILE                0x00000003
#define SR_ERR_FILE_SIZE                0x00000004
...
#define SR_MANUAL_ERR_CANT_ALLOC_MEM 0x50000001
